...
### 🧿 3.2 ผลการทดลองและการวัดประสิทธิภาพของโมเดล Layout Detection (YOLO)
...
### 🤖 3.2.1 การวิเคราะ Confusion Matrix และการคัดเลือกตัวแบบ (Confusion Matrix & Model Selection)
...
### 3.2.3 ผลสัมฤทธิ์การวิเคราะห์โครงสร้างเชิงพื้นที่จริง (YOLO11s Inference Results):
...
## 3.3 ผลการทดลองเปรียบเทียบประสิทธิภาพกลไกสกัดข้อความ (OCR Engines Performance)
...
เพื่อคัดเลือกกลไกการสกัดข้อความที่มีความถูกต้องสูงสุด คณะผู้จัดทำได้ทำการทดลองเปรียบเทียบประสิทธิภาพของกลไกประมวลผลอักขระอัตโนมัติ (OCR Engines) จำนวน 4 ตัวเลือกหลัก ได้แก่ PaddleOCR, Surya
